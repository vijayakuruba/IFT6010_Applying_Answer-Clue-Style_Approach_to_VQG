...
DATA_PATH = "./dataq/"
PROJECT_PATH = "/".join(HOME_PATH[:-4]) + "/FQG/"
...
FUNCTION_WORDS_FILE_PATH = DATA_PATH + "original/function_words.txt"
FIXED_EXPRESSIONS_FILE_PATH = DATA_PATH + "original/fixed_expressions.txt"
...
QUESTION_TYPES = [
    "Who", "Where", "When", "Why",
    "Which", "Which one of", "Which of",
    "What", "What type of", "What kind of", "What color",
    "How", "How many", "How often", "How long", "How much",
    "Boolean", "Other"]
INFO_QUESTION_TYPES = [
    "Who", "Where", "When", "Why",
    "Which", "Which one of", "Which of", "Which color",
    "What", "What type of", "What kind of", "What color",
    "How", "How many", "How often", "How long", "How much"]
BOOL_QUESTION_TYPES = [
    "Am", "Is", "Was", "Were", "Are",
...
Q_TYPE2ID_DICT = {
    ...
    "Which one of": 9, "Which of": 10,
    "What type of": 11, "What kind of": 12, "What color": 13,
    "How many": 14, "How often": 15, "How long": 16, "How much": 17
}
